...
/**
 * PAN card upload control for the trainer My Account page.
 *
 * @param props - Document preview URL, refs, and upload handlers.
 */
export default function TrainerPanDocumentUpload({
  documentUrl,
  isPdf,
  panDocumentInputRef,
  uploading,
  ...
  return (
    <>
      <input
        type="file"
        ref={panDocumentInputRef as RefObject<HTMLInputElement>}
