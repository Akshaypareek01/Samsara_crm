...
import {
    getMenopauseStats,
    getMenopauseEngagement,
    MENOPAUSE_ENGAGEMENT_LEGEND,
    type StatCard,
    ...
    <div className="box mb-0">
        <div className="box-body p-4">
            <div className="flex items-start justify-between">
                ...
                >
                    <i className="bx bx-female text-base" style={{ color: card.iconColor }}></i>
                </div>
            </div>
        </div>
    </div>
...
const MenopausePage = () => {
    ...
    useEffect(() => {
        ...
        getMenopauseStats().then(setStats);
        getMenopauseEngagement().then(setChartData);
    }, []);

    return (
        <Fragment>
            <Seo title="Menopause" />
            <Pageheader currentpage="Menopause" activepage="Women's Program" mainpage="Menopause" />
            ...
            <div className="box mb-0">
                <div className="box-header justify-between items-center">
                    <h6 className="box-title font-bold !mb-0">User Engagement Analytics</h6>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={chartData} barGap={4} barCategoryGap="30%">
                            ...
                            <Legend
                                ...
                                formatter={(value) => {
                                    const found = MENOPAUSE_ENGAGEMENT_LEGEND.find((l) => l.label === value);
                                    return found ? found.label : value;
                                }}
                            />
                            {MENOPAUSE_ENGAGEMENT_LEGEND.map((legend) => (
                                <Bar
                                    key={legend.key}
                                    dataKey={legend.key}
                                    name={legend.label}
