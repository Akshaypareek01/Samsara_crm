...
export const COMPANY_TERMS_SECTIONS: CompanyLegalSection[] = [
  {
    ...
    bullets: [
      ...
      'No Employment Relationship: The wellness professionals (including Yoga Trainers, Sound Healers, Psychologists, and Employee Assistance Program [EAP] Trainers, collectively referred to as "Trainers") visible on this CRM are independent, third-party service providers. They are not employees, agents, or joint-venture partners of Samsara Wellness.',
